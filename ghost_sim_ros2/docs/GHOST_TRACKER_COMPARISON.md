...
The comparison answers a research question that single demos cannot:

> Given the same observations before disappearance, does the occlusion estimator
> outperform a constant-velocity baseline, and does it preserve plausible future
> branches instead of hallucinating one unbounded path?
...
2. IMM improving over CV on maneuver cases,
3. top-three GHOST-MH futures covering more occlusion outcomes than a single
   point estimate,
